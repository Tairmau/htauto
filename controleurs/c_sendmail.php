    ...
    case 'sendmail':
        {
            ...
            if(strpos($email, $targetDomain) !== false){
                ...
                $nom = $login;
                $message = 'Bonjour Monsieur/Madame ' . $nom . '<br><br>Veuillez prendre connaissance du lieu et horaires choisis pour la visite.<br>Voici les horaires :<br>' .$date. 'heure : '.$heure. '<br> Voiture selectionner : ' .$modele .' - '.$type.' - '.$annee;
